-- Ported from the pre-Zed config (nvim-old, Jan 2026), kept commented out.
--
-- Picks biome or prettier per project by searching upward from the buffer for
-- a config file, falling back to prettier. Pair it with conform.nvim, e.g.:
--
--   formatters_by_ft = {
--     javascript = require("utils.format").biome_or_prettier,
--   }
--
-- To use: uncomment below and wire it into your conform config.
-- Note it was written against the old setup and may need updating.
...
--       vim.cmd("edit!")
--     else
--       vim.notify("Biome error: " .. result, vim.log.levels.ERROR)
--     end
--   end
